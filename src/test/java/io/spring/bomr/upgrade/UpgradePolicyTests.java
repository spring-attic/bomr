...
public class UpgradePolicyTests {
	...
	@Test
	public void anyWhenCandidateIsNewerMajorThanCurrentShouldReturnTrue()
			throws InvalidVersionSpecificationException {
		assertThat(UpgradePolicy.ANY.test(version("2.0.0"), version("1.0.0"))).isTrue();
	}

	@Test
	public void anyWhenCandidateIsNewerMinorThanCurrentShouldReturnTrue()
			throws InvalidVersionSpecificationException {
		assertThat(UpgradePolicy.ANY.test(version("1.1.0"), version("1.0.0"))).isTrue();
	}

	@Test
	public void anyWhenCandidateIsNewerPatchThanCurrentShouldReturnTrue()
			throws InvalidVersionSpecificationException {
		assertThat(UpgradePolicy.ANY.test(version("1.0.1"), version("1.0.0"))).isTrue();
	}

	@Test
	public void anyWhenCandidateIsSameAsCurrentShouldReturnFalse()
			throws InvalidVersionSpecificationException {
		assertThat(UpgradePolicy.ANY.test(version("1.0.0"), version("1.0.0"))).isFalse();
	}

	@Test
	public void anyWhenCandidateIsOlderThanCurrentShouldReturnFalse()
			throws InvalidVersionSpecificationException {
	...
	public void sameMajorVersionWhenCandidateIsNewerMajorThanCurrentShouldReturnFalse()
			throws InvalidVersionSpecificationException {
		assertThat(
				UpgradePolicy.SAME_MAJOR_VERSION.test(version("2.0.0"), version("1.0.0")))
						.isFalse();
	}
	...
	public void sameMajorVersionWhenCandidateIsNewerMinorThanCurrentShouldReturnTrue()
			throws InvalidVersionSpecificationException {
		assertThat(
				UpgradePolicy.SAME_MAJOR_VERSION.test(version("1.1.0"), version("1.0.0")))
						.isTrue();
	}
	...
	public void sameMajorVersionWhenCandidateIsNewerPatchThanCurrentShouldReturnTrue()
			throws InvalidVersionSpecificationException {
		assertThat(
				UpgradePolicy.SAME_MAJOR_VERSION.test(version("1.0.1"), version("1.0.0")))
						.isTrue();
	}
	...
	public void sameMajorVersionWhenCandidateIsSameAsCurrentShouldReturnFalse()
			throws InvalidVersionSpecificationException {
		assertThat(
				UpgradePolicy.SAME_MAJOR_VERSION.test(version("1.0.0"), version("1.0.0")))
						.isFalse();
	}
	...
	public void sameMajorVersionWhenCandidateIsOlderThanCurrentShouldReturnFalse()
			throws InvalidVersionSpecificationException {
		assertThat(
				UpgradePolicy.SAME_MAJOR_VERSION.test(version("2.0.0"), version("2.1.0")))
						.isFalse();
	}
	...
	public void sameMinorVersionWhenCandidateIsNewerMajorThanCurrentShouldReturnFalse()
			throws InvalidVersionSpecificationException {
		assertThat(
				UpgradePolicy.SAME_MINOR_VERSION.test(version("2.0.0"), version("1.0.0")))
						.isFalse();
	}
	...
	public void sameMinorVersionWhenCandidateIsNewerMinorThanCurrentShouldReturnFalse()
			throws InvalidVersionSpecificationException {
		assertThat(UpgradePolicy.SAME_MINOR_VERSION.test(version("10.13.1"),
				version("10.14.1"))).isFalse();
	}
	...
	public void sameMinorVersionWhenCandidateIsNewerPatchThanCurrentShouldReturnTrue()
			throws InvalidVersionSpecificationException {
		assertThat(
				UpgradePolicy.SAME_MINOR_VERSION.test(version("1.0.1"), version("1.0.0")))
						.isTrue();
	}
	...
	public void sameMinorVersionWhenCandidateIsSameAsCurrentShouldReturnFalse()
			throws InvalidVersionSpecificationException {
		assertThat(
				UpgradePolicy.SAME_MINOR_VERSION.test(version("1.0.0"), version("1.0.0")))
						.isFalse();
	}
	...
	public void sameMinorVersionWhenCandidateIsOlderThanCurrentShouldReturnFalse()
			throws InvalidVersionSpecificationException {
		assertThat(
				UpgradePolicy.SAME_MINOR_VERSION.test(version("2.1.0"), version("2.1.1")))
						.isFalse();
	}
